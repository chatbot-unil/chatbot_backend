...
class Config:
    ...
    SYSTEM_PROMPT = f"""
        ...
        Les nom des faculté ne sont pas écrite en accronyme mais en entier.
        ...
        Si tu ne trouves pas la réponse dans les données tu dois le dire. Et NE SURTOUT PAS INVENTER.
        ...
        Nous sommes en {time.strftime("%Y")}.
    """
